...
from server.models.kokoro_onnx_model import KokoroONNXModel
from server.models.kokoro_onnx_official import KokoroONNXOfficialModel
...
MODEL_REGISTRY: dict[str, type[TTSModel]] = {
    "kokoro": KokoroModel,
    "kokoro_onnx": KokoroONNXOfficialModel,  # Official optimized ONNX version
    "kokoro_onnx_custom": KokoroONNXModel,  # Custom implementation (backup)
